...
Font::Font(IDirect3DDevice9* pDevice)
	:m_pDevice(pDevice),
	m_FT2Lib(NULL),
	m_FT_Face(NULL),
	_bOutLine(false),
...
void Font::DrawSimpleText(const std::string& str, const int& size, const ImVector2& pos, const DWORD& color, bool bOutLine /*= false*/)
{
	if (str.empty())
	{
		return;
...
void Font::render(std::vector<FontVertex>& fontVecs)
{
